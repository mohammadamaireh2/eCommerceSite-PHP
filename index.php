...
<div id="bootstrap-touch-slider" class="carousel bs-slider fade control-round indicators-line" data-ride="carousel" data-pause="hover" data-interval="false" >
    ...
    <div class="carousel-inner" role="listbox">
        ...
        foreach ($result as $row) {            
            ?>
            <div class="item <?php if($i==0) {echo 'active';} ?>" style="background-image:url(assets/images/<?php echo $row['photo']; ?>);">
        ...
        <div class="row">
            ...
            foreach ($services as $service): ?>
                <div class="col-md-4">
                    <div class="item">
                        <div class="photo">
                            <img src="assets/uploads/<?= htmlspecialchars($service['photo']); ?>" width="150px" alt="<?= htmlspecialchars($service['title']); ?>">
                        </div>
...
<?php 
$home_featured_product_on_off = 1;
if($home_featured_product_on_off == 1): ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <!-- <div class="headline">
                    <h2><?php
                     echo $featured_product_title; ?></h2>
...
if($home_latest_product_on_off == 4): ?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
                    ...
                    $latest_product_title='Latest Product';
                    echo $latest_product_title; ?>
...
if($home_popular_product_on_off == 1): ?>
<div class="product pt_70 pb_70">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
                    <h2><?php  $popular_product_title; ?></h2>
                    <h3><?php  $popular_product_subtitle; ?></h3>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="product-carousel">
                    ...
                    <?php
                    $statement = $pdo->prepare("SELECT * FROM tbl_product WHERE p_is_active=? ORDER BY p_total_view DESC LIMIT ".$total_popular_product_home=4);
                    $statement->execute(array(1));
                    $result = $statement->fetchAll(PDO::FETCH_ASSOC);                            
                    foreach ($result as $row) {
                        ?>
