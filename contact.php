...
?>
                ...
                ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <address>
                            <?php 
                            $contact_address="aqab,jordan";
                            
                            echo nl2br($contact_address); ?>
                        </address>
                        <address>
...
//                 $longitude = -122.4194;
//                 $zoom = 12;
//                 $api_key = 'AIzaSyAJhimWQhRUJtgNpxaL8ELyyoxgQCnyifQ';
...
//     frameborder='0'
//     style='border:0'
//     src='https://www.google.com/maps/embed/v1/view?key={$api_key}&center={$latitude},{$longitude}&zoom={$zoom}'
//     allowfullscreen
// ></iframe>";
