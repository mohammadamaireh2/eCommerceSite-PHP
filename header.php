...
<head>
	...
	<link rel="stylesheet"  href="assets/css/main.styles.css?v=1.1">
	...
	<?php
$before_head = ""; // Set to an appropriate value.
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<div class="left">
					<ul>
						...
						$contact_phone="+962-790-586-256";
						echo $contact_phone; ?></li>
						<li><i class="fa fa-envelope-o"></i> <?php $contact_email="amaireh@gmail.com";echo $contact_email; ?></li>
					</ul>
				</div>
			</div>
			<div class="col-md-6 col-sm-6 col-xs-12">
	...
	<div class="container">
		<div class="row inner">
			<div class="col-md-4 logo">
				...
				<a href="index.php"><img src="assets/uploads copy/borcelle.png"
				<?php 
				$logo = 'assets/uploads copy/borcelle.png';
				echo $logo;?>></a>
			</div>
			...
			<div class="col-md-5 right">
				<ul>
					...
					if(isset($_SESSION['customer'])) {
						?>
						<li><i class="fa fa-user"></i> <?php $LANG_VALUE_13=1;         echo $LANG_VALUE_13; ?> <?php echo $_SESSION['customer']['cust_name']; ?></li>
