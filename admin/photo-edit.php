...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
    	...
    	if($path == '') {
    		...
    		unlink('../assets/uploads copy/'.$_POST['previous_photo']);

    		$final_name = 'photo-'.$_REQUEST['id'].'.'.$ext;
        	move_uploaded_file( $path_tmp, '../assets/uploads copy/'.$final_name );
					...
					<div class="box-body">
						...
						<div class="form-group">
				            ...
				            <div class="col-sm-6" style="padding-top:6px;">
				                <img src="../assets/images/<?php echo $photo; ?>" class="existing-photo" style="width:300px;">
