...
(1, 'slider-3.jpg', 'Welcome to Ecommerce PHP', 'Shop Online for Latest Fashion style', 'Shop Now', 'product-category.php?id=4&type=mid-category', 'Center'),
(2, 'slider-2.jpg', '50% Discount on All Products', , 'Read More', '#', 'Center'),
(3, 'slider-1.jpg', '24 Hours Customer Support', , 'Read More', '#', 'Right');
